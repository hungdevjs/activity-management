        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlusPoint = table.Column<int>(type: "int", nullable: false),
                    MinusPoint = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EndTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    SignUpStartTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    SignUpEndTime = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentPoints", x => new { x.StudentId, x.SemesterId });
                    table.ForeignKey(
                        name: "FK_StudentPoints_Semesters_SemesterId",
                        column: x => x.SemesterId,
                        principalTable: "Semesters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentPoints_SemesterId",
                table: "StudentPoints",
                column: "SemesterId");

            migrationBuilder.CreateIndex(
                name: "IX_TeacherActivities_ActivityId",
